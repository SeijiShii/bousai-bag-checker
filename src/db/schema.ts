...
export const items = pgTable(
  "items",
  {
    ...
    freshnessType: freshnessTypeEnum("freshness_type")
      .notNull()
      .default("expiry"),
  ...
  (t) => [
    ...
    index("items_user_expires_idx").on(t.userId, t.expiresAt),
  ],
);
...
// アプリ内通知 (_shared/notification が追加)。title/body に PII を含めない (SEC-002)。
...
export const emailDeliveries = pgTable(
  ...
  (t) => [index("email_deliveries_user_idx").on(t.userId)],
);
